...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_del = true;
    ui->tianqi_page_del = true;
    ui->shezhi_del = true;
    ui->duogongneng_del = true;
    ui->tianqi_page1_del = true;
    ui->temp_page_del = true;
    ui->light_page_del = true;
    ui->txt_page_del = true;
    ui->connect_page_del = true;
    ui->music_list_del = true;
    ui->txt_veiw_del = true;
    ui->settings_page_del = true;
    ui->heart_page_del = true;
    ui->vol_page_del = true;
    ui->lis_page_del = true;
    ui->math_page_del = true;
