...
void screen_digital_clock_home_timer(lv_timer_t *timer)
{
    ...
    {
        lv_dclock_set_text_fmt(guider_ui.screen_digital_clock_home, "%d:%02d:%02d %s", screen_digital_clock_home_hour_value, screen_digital_clock_home_min_value, screen_digital_clock_home_sec_value, screen_digital_clock_home_meridiem);
    }
}
